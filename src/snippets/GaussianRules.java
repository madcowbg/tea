...
public class GaussianRules<Op extends Operator, Symbol> extends ProbabilisticRules<Op, Symbol> {
    ...
    public final List<Operations.Rule<Object, Object>> GAUSSIAN_DISTRIBUTION_INCORPORATE_LINEAR_COMBINATION_RULES() {
        return List.of(
                new Operations.Rule<>(
                        List.of(prod, List.of("?c", "m"), List.of(Normal, List.of("?", "v"), List.of("?", "mu"), List.of("?", "sigma"))),
                        List.of(Normal,
                                List.of(prod, List.of(sign, List.of(":", "m")), List.of(":", "v")),
                                List.of(prod, List.of(":", "m"), List.of(":", "mu")),
                                List.of(prod, List.of(prod, List.of(sign, List.of(":", "m")), List.of(":", "m")), List.of(":", "sigma")))),
                new Operations.Rule<>(
                        List.of(sum, List.of("?c", "a"), List.of(Normal, List.of("?", "v"), List.of("?", "mu"), List.of("?", "sigma"))),
                        List.of(Normal, List.of(":", "v"), List.of(sum, List.of(":", "a"), List.of(":", "mu")), List.of(":", "sigma"))));
    }
